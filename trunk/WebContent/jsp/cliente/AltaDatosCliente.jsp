    		...
    		<html:form action="/IrConfirmarDatosClienteAction.do" method="post">
				<fieldset class="fondoAzulMedio bordeNulo relleno0 margen2 alto100P">
	                ...
	                <div id="email-div" class="alto50">
	                   ...
	                   <html:text property="email" size="100" maxlength="30" styleClass="fondoBlanco"></html:text>
	                </div>
	                <div id="email2-div" class="alto50">
	                   <label for="email2" class="texto100 col20"><strong>Correo electrónico:&nbsp;</strong></label>
	                   <html:text property="email2" size="100" maxlength="30" styleClass="fondoBlanco"></html:text>
	                </div>
