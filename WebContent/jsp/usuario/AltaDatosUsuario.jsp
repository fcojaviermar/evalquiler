			...
			<html:form action="/IrConfirmarDatosUsuarioAction.do" method="post">
				<fieldset class="fondoAzulMedio bordeNulo relleno0 margen2 alto100P">
	                ...
	                <div id="User-div" class="alto25">
	                    <label for="user" class="texto95 col20"><strong>Usuario:&nbsp;</strong></label>
	                ...
	                <div id="Password-div" class="alto25">
	                    <label for="Password" class="texto95 col20"><strong>Contraseña:&nbsp;</strong></label>
	                ...
	                <div id="Password2-div" class="alto25">
	                    <label for="Password" class="texto95 col20"><strong>Repetir contraseña:&nbsp;</strong></label>
					...
					<div id="tipo_nifcif-div" class="alto25">
	                    <label for="tipo_nifcif" class="texto95 col20"><strong>Tipo documento:&nbsp;</strong></label>
	                 ...
	                 <div id="nifcif-div" class="alto25">
	                    <label for="nifcif" class="texto95 col20"><strong>N.I.F./C.I.F:&nbsp;</strong></label>
	                 ...
	                 <div id="email-div" class="alto25">
	                    <label for="email" class="texto95 col20"><strong>Correo electrónico:&nbsp;</strong></label>
	                 ...
	                 <div id="email2-div" class="alto25">
	                    <label for="email2" class="texto95 col20"><strong>Repetir correo electrónico:&nbsp;</strong></label>
	                 ...
	                 <div id="tipo_usuario-div" class="alto25">
	                     <label for="tipo_usuario" class="texto95 col20"><strong>Tipo usuario:&nbsp;</strong></label>
